...
import com.brownfield.pss.book.proxy.FareServiceProxy;
...
public class BookingComponent {
	...
	public long book(BookingRecord record) {
		...
		//Fare fare = restTemplate.getForObject(fareServiceProxy +"/get?flightNumber="+record.getFlightNumber()+"&flightDate="+record.getFlightDate(),Fare.class);
